...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-67 flex-col overflow-y-hidden border-r border-primary bg-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-2">
              <NavLink
                to="/dashboard"
                className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:bg-primary hover:text-white dark:hover:bg-meta-4 ${
              ...
              {/* <!-- Menu Item Departments --> */}
              {/* <!-- Menu Item TroubleShooting --> */}
              <li>
                <NavLink
                  to="/troubleshoot"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:bg-primary hover:text-white dark:hover:bg-meta-4 ${
                    pathname.includes('trouble') &&
                    'bg-primary text-white dark:bg-meta-4'
                  }`}
                >
                  <svg
                  ...
                  >
                    <path
                      d="M21.0801 20.904L15.8231 15.646C15.0884 16.2433 14.3311 16.7017 13.5511 17.021C12.7711 17.3403 11.8887 17.5 10.9041 17.5C9.55739 17.5 8.32806 17.1813 7.21606 16.544C6.10406 15.9067 5.21739 15.0587 4.55606 14H5.79406C6.39939 14.758 7.14206 15.364 8.02206 15.818C8.90206 16.2727 9.86273 16.5 10.9041 16.5C12.6987 16.5 14.2307 15.8653 15.5001 14.596C16.7694 13.3267 17.4041 11.7947 17.4041 10C17.4041 8.20533 16.7694 6.67333 15.5001 5.404C14.2307 4.13467 12.6987 3.5 10.9041 3.5C9.19606 3.5 7.72339 4.08033 6.48606 5.241C5.24873 6.40167 4.56306 7.82133 4.42906 9.5H3.42906C3.56239 7.524 4.34039 5.86333 5.76306 4.518C7.18573 3.17267 8.89906 2.5 10.9031 2.5C12.9964 2.5 14.7697 3.22667 16.2231 4.68C17.6764 6.13333 18.4031 7.90667 18.4031 10C18.4031 10.9847 18.2437 11.8703 17.9251 12.657C17.6064 13.4437 17.1481 14.2043 16.5501 14.939L21.7881 20.177L21.0801 20.904ZM10.0401 13.692L8.27406 7.82L6.74406 12.193H2.21106V11.309H6.11406L7.76406 6.559H8.82206L10.5591 12.389L11.9031 8.309H12.9611L14.4611 11.309H15.2881V12.193H13.9201L12.4951 9.343L11.0721 13.693L10.0401 13.692Z"
                      fill=""
                    />
                  </svg>
                  Troubleshoot
